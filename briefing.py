...
def synthesize_briefing(prices: dict, news: dict) -> str:
    ...
    system_prompt = (
        ...
        "Flag any move >2% or material news event at the top. "
        "Be declarative — verdicts, not descriptions. Use USD for prices."
    )
...
<style>
  ...
  .footer    {{ background:#f4f4f4; padding:14px 30px; font-size:11px; color:#888; text-align:center; }}
</style>
</head>
<body>
<div class="container">
  <div class="header">
    ...
    <p>{today} · 08:00 CET · Watchlist: TPG · ECO</p>
  </div>
  <div class="body">
    {narrative_html}
  ...
  <div class="footer">
    Generated by Claude · Data: Yahoo Finance · News: Perplexity · For internal use only
  </div>
</div>
</body>
</html>"""
...
def send_email(html_body: str):
    ...
    subject = f"Morning Briefing · TPG · ECO · {today}"
...
def main():
    ...
    briefing = synthesize_briefing(prices, news)
